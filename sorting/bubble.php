...
<html lang="en-GB" xmlns="http://www.w3.org/1999/xhtml" xml:lang="" class="no-js">
    <head>
        ...
        <script>
            $(function() {
                var numBlocks = 300, a = shuffle(range(1, numBlocks)), blockheight = 300, blockwidth = 10, intval, canvas, context, width, height, n = a.length;
                ...
                var updateFreq = function(freq) {
                    oscillator.type = parseInt(3);
                    oscillator.frequency.value = freq;
                    oscillator.connect(oscContext.destination);
                    oscillator.noteOn;//DISABLED DUE TO BUG IN CHROME && oscillator.noteOn(0); // this method doesn't seem to exist, though it's in the docs?
                };

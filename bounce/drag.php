...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(function() {
                var points = [], maxPoints = 5000, numPoints = 0, dotsize = 5, dragging = false, gravity = 0.5, sidePull = 0, i, j, intval, canvas, context, width, height, bounce = -0.9, drag = 0.97, mass = 10;
